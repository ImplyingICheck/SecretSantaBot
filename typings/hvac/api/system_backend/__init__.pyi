...
__all__ = ("Audit", "Auth", "Capabilities", "Health", "Init", "Key", "Leader", "Lease", "Mount", "Namespace", "Policy", "Raft", "Seal", "SystemBackend", "SystemBackendMixin", "Wrapping")
logger = ...
class SystemBackend(VaultApiCategory, Audit, Auth, Capabilities, Health, Init, Key, Leader, Lease, Mount, Namespace, Policy, Raft, Seal, Wrapping):
    implemented_classes = ...
