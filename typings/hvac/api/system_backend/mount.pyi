...
class Mount(SystemBackendMixin):
    ...
    def enable_secrets_engine(self, backend_type, path=..., description=..., config=..., plugin_name=..., options=..., local=..., seal_wrap=..., **kwargs):
    ...
    def tune_mount_configuration(self, path, default_lease_ttl=..., max_lease_ttl=..., description=..., audit_non_hmac_request_keys=..., audit_non_hmac_response_keys=..., listing_visibility=..., passthrough_request_headers=..., options=..., force_no_cache=..., **kwargs):
