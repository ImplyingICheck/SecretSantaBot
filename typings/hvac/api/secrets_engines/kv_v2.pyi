...
class KvV2(VaultApiBase):
    ...
    """
    def configure(self, max_versions=..., cas_required=..., delete_version_after=..., mount_point=...):
    ...
    def read_secret(self, path: str, mount_point=..., raise_on_deleted_version=...) -> dict[str, dict[str, dict[str, str]]]:
    ...
    def read_secret_version(self, path, version=..., mount_point=..., raise_on_deleted_version=...):
    ...
    def create_or_update_secret(self, path: str, secret: dict[str, Any], cas=..., mount_point=...) -> dict[str, dict[str, dict[str, str]]]:
    ...
    def update_metadata(self, path, max_versions=..., cas_required=..., delete_version_after=..., mount_point=..., custom_metadata=...):
