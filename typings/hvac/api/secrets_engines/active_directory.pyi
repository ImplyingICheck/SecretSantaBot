...
class ActiveDirectory(VaultApiBase):
    ...
    """
    def configure(self, binddn=..., bindpass=..., url=..., userdn=..., upndomain=..., ttl=..., max_ttl=..., mount_point=..., *args, **kwargs):
    ...
    def create_or_update_role(self, name, service_account_name=..., ttl=..., mount_point=...):
