...
class Transit(VaultApiBase):
    ...
    """
    def create_key(self, name, convergent_encryption=..., derived=..., exportable=..., allow_plaintext_backup=..., key_type=..., mount_point=..., auto_rotate_period=...):
    ...
    def update_key_configuration(self, name, min_decryption_version=..., min_encryption_version=..., deletion_allowed=..., exportable=..., allow_plaintext_backup=..., mount_point=..., auto_rotate_period=...):
    ...
    def export_key(self, name, key_type, version=..., mount_point=...):
    ...
    def encrypt_data(self, name, plaintext, context=..., key_version=..., nonce=..., batch_input=..., type=..., convergent_encryption=..., mount_point=...):
    ...
    def decrypt_data(self, name, ciphertext, context=..., nonce=..., batch_input=..., mount_point=...):
    ...
    def rewrap_data(self, name, ciphertext, context=..., key_version=..., nonce=..., batch_input=..., mount_point=...):
    ...
    def generate_data_key(self, name, key_type, context=..., nonce=..., bits=..., mount_point=...):
    ...
    def generate_random_bytes(self, n_bytes=..., output_format=..., mount_point=...):
    ...
    def hash_data(self, hash_input, algorithm=..., output_format=..., mount_point=...):
    ...
    def generate_hmac(self, name, hash_input, key_version=..., algorithm=..., mount_point=...):
    ...
    def sign_data(self, name, hash_input=..., key_version=..., hash_algorithm=..., context=..., prehashed=..., signature_algorithm=..., marshaling_algorithm=..., salt_length=..., mount_point=..., batch_input=...):
    ...
    def verify_signed_data(self, name, hash_input, signature=..., hmac=..., hash_algorithm=..., context=..., prehashed=..., signature_algorithm=..., salt_length=..., marshaling_algorithm=..., mount_point=...):
    ...
    def restore_key(self, backup, name=..., force=..., mount_point=...):
