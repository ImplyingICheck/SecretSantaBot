...
class Aws(VaultApiBase):
    ...
    """
    def configure_root_iam_credentials(self, access_key, secret_key, region=..., iam_endpoint=..., sts_endpoint=..., max_retries=..., mount_point=...):
    ...
    def create_or_update_role(self, name, credential_type, policy_document=..., default_sts_ttl=..., max_sts_ttl=..., role_arns=..., policy_arns=..., legacy_params=..., iam_tags=..., mount_point=...):
    ...
    def generate_credentials(self, name, role_arn=..., ttl=..., endpoint=..., mount_point=..., role_session_name=...):
