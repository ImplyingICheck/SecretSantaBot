...
class Consul(VaultApiBase):
    ...
    """
    def configure_access(self, address, token, scheme=..., mount_point=...):
    ...
    def create_or_update_role(self, name, policy=..., policies=..., token_type=..., local=..., ttl=..., max_ttl=..., mount_point=...):
