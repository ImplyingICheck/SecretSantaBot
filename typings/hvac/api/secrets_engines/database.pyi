...
class Database(VaultApiBase):
    ...
    """
    def configure(self, name, plugin_name, verify_connection=..., allowed_roles=..., root_rotation_statements=..., mount_point=..., *args, **kwargs):
    ...
    def create_role(self, name, db_name, creation_statements, default_ttl=..., max_ttl=..., revocation_statements=..., rollback_statements=..., renew_statements=..., mount_point=...):
    ...
    def create_static_role(self, name, db_name, username, rotation_statements, rotation_period=..., mount_point=...):
