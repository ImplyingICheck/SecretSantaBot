...
class Gcp(VaultApiBase):
    ...
    """
    def configure(self, credentials=..., google_certs_endpoint=..., mount_point=...):
    ...
    def create_role(self, name, role_type, project_id, ttl=..., max_ttl=..., period=..., policies=..., bound_service_accounts=..., max_jwt_exp=..., allow_gce_inference=..., bound_zones=..., bound_regions=..., bound_instance_groups=..., bound_labels=..., mount_point=...):
    ...
    def edit_service_accounts_on_iam_role(self, name, add=..., remove=..., mount_point=...):
    ...
    def edit_labels_on_gce_role(self, name, add=..., remove=..., mount_point=...):
    ...
    def login(self, role, jwt, use_token=..., mount_point=...):
