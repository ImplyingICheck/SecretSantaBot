...
class Aws(VaultApiBase):
    ...
    """
    def configure(self, max_retries=..., access_key=..., secret_key=..., endpoint=..., iam_endpoint=..., sts_endpoint=..., iam_server_id_header_value=..., mount_point=...):
    ...
    def configure_identity_integration(self, iam_alias=..., ec2_alias=..., mount_point=...):
    ...
    def create_certificate_configuration(self, cert_name, aws_public_cert, document_type=..., mount_point=...):
    ...
    def configure_identity_whitelist_tidy(self, safety_buffer=..., disable_periodic_tidy=..., mount_point=...):
    ...
    def configure_role_tag_blacklist_tidy(self, safety_buffer=..., disable_periodic_tidy=..., mount_point=...):
    ...
    def create_role(self, role, auth_type=..., bound_ami_id=..., bound_account_id=..., bound_region=..., bound_vpc_id=..., bound_subnet_id=..., bound_iam_role_arn=..., bound_iam_instance_profile_arn=..., bound_ec2_instance_id=..., role_tag=..., bound_iam_principal_arn=..., inferred_entity_type=..., inferred_aws_region=..., resolve_aws_unique_ids=..., ttl=..., max_ttl=..., period=..., policies=..., allow_instance_migration=..., disallow_reauthentication=..., mount_point=...):
    ...
    def create_role_tags(self, role, policies=..., max_ttl=..., instance_id=..., allow_instance_migration=..., disallow_reauthentication=..., mount_point=...):
    ...
    def iam_login(self, access_key, secret_key, session_token=..., header_value=..., role=..., use_token=..., region=..., mount_point=...):
        """Fetch a token
    ...
    def ec2_login(self, pkcs7, nonce=..., role=..., use_token=..., mount_point=...):
    ...
    def tidy_blacklist_tags(self, saftey_buffer=..., mount_point=...):
    ...
    def tidy_identity_whitelist_entries(self, saftey_buffer=..., mount_point=...):
