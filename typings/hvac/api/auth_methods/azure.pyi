...
class Azure(VaultApiBase):
    ...
    """
    def configure(self, tenant_id, resource, environment=..., client_id=..., client_secret=..., mount_point=...):
    ...
    def create_role(self, name, policies=..., ttl=..., max_ttl=..., period=..., bound_service_principal_ids=..., bound_group_ids=..., bound_locations=..., bound_subscription_ids=..., bound_resource_groups=..., bound_scale_sets=..., num_uses=..., mount_point=...):
    ...
    def login(self, role, jwt, subscription_id=..., resource_group_name=..., vm_name=..., vmss_name=..., use_token=..., mount_point=...):
        """Fetch a token.
