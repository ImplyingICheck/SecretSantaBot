...
class Token(VaultApiBase):
    ...
    """
    def create(self, id=..., role_name=..., policies=..., meta=..., no_parent=..., no_default_policy=..., renewable=..., ttl=..., type=..., explicit_max_ttl=..., display_name=..., num_uses=..., period=..., entity_alias=..., wrap_ttl=..., mount_point=...):
        """Create a new token.
    ...
    def create_orphan(self, id=..., role_name=..., policies=..., meta=..., no_default_policy=..., renewable=..., ttl=..., type=..., explicit_max_ttl=..., display_name=..., num_uses=..., period=..., entity_alias=..., wrap_ttl=..., mount_point=...):
    ...
    def renew(self, token, increment=..., wrap_ttl=..., mount_point=...):
    ...
    def renew_self(self, increment=..., wrap_ttl=..., mount_point=...):
    ...
    def renew_accessor(self, accessor, increment=..., wrap_ttl=..., mount_point=...):
    ...
    def create_or_update_role(self, role_name, allowed_policies=..., disallowed_policies=..., orphan=..., renewable=..., path_suffix=..., allowed_entity_aliases=..., mount_point=..., token_period=..., token_explicit_max_ttl=...):
