...
class JWT(VaultApiBase):
    ...
    """
    DEFAULT_PATH = ...
    def resolve_path(self, path): # -> Literal['jwt']:
    ...
    def configure(self, oidc_discovery_url=..., oidc_discovery_ca_pem=..., oidc_client_id=..., oidc_client_secret=..., oidc_response_mode=..., oidc_response_types=..., jwks_url=..., jwks_ca_pem=..., jwt_validation_pubkeys=..., bound_issuer=..., jwt_supported_algs=..., default_role=..., provider_config=..., path=...):
    ...
    def create_role(self, name, user_claim, allowed_redirect_uris, role_type=..., bound_audiences=..., clock_skew_leeway=..., expiration_leeway=..., not_before_leeway=..., bound_subject=..., bound_claims=..., groups_claim=..., claim_mappings=..., oidc_scopes=..., bound_claims_type=..., verbose_oidc_logging=..., token_ttl=..., token_max_ttl=..., token_policies=..., token_bound_cidrs=..., token_explicit_max_ttl=..., token_no_default_policy=..., token_num_uses=..., token_period=..., token_type=..., path=..., user_claim_json_pointer=...):
    ...
    def delete_role(self, name, path=...):
    ...
    def oidc_authorization_url_request(self, role, redirect_uri, path=...):
    ...
    def oidc_callback(self, state, nonce, code, path=...):
    ...
    def jwt_login(self, role, jwt, use_token=..., path=...):
        """Fetch a token.
