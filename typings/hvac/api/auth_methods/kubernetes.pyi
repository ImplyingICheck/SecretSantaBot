...
class Kubernetes(VaultApiBase):
    ...
    """
    def configure(self, kubernetes_host, kubernetes_ca_cert=..., token_reviewer_jwt=..., pem_keys=..., issuer=..., mount_point=..., disable_local_ca_jwt=...):
    ...
    def create_role(self, name, bound_service_account_names, bound_service_account_namespaces, ttl=..., max_ttl=..., period=..., policies=..., token_type=..., mount_point=..., alias_name_source=...):
